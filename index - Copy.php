...
<html lang="en">
    <head>
        ...
        <link href="style/templates/css/litepicker.css" rel="stylesheet" />
    ...
    <body class="nav-fixed">
            ...
            <ul class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0 me-sm-n15 me-lg-0 o-hidden animated--fade-in-up" aria-labelledby="navbarDropdownDocs">
                        <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-admin-pro" target="_blank">
                            ...
                            <div>
                                ...
                                Usage instructions and reference                            </div>
                        </a>
                        ...
                        <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-admin-pro/components" target="_blank">
                            ...
                            <div>
                                ...
                                Code snippets and reference                            </div>
                        </a>
                        <div class="dropdown-divider m-0"></div>
                ...
                <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownAlerts">
                        ...
                        <a class="dropdown-item dropdown-notifications-footer" href="#!">View All Alerts</a>                    </div>
                </li>
                <!-- Messages Dropdown-->
                <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                        ...
                        <!-- Footer Link-->
                        <a class="dropdown-item dropdown-notifications-footer" href="#!">Read All Messages</a>                    </div>
                </li>
                <!-- User Dropdown-->
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                ...
                                <div class="dropdown-user-details-email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b3c5dfc6ddd2f3d2dcdf9dd0dcde">[email&#160;protected]</a></div>
                            </div>
                        </h6>
                    ...
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link d-sm-none" href="#!">
                                ...
                                Alerts
                                <span class="badge bg-warning-soft text-warning ms-auto">4 New!</span>                            </a>
                            ...
                            <div class="collapse" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                    <a class="nav-link" href="dashboard-1.html">
                                        Default
                                        <span class="badge bg-primary-soft text-primary ms-auto">Updated</span>                                    </a>
                                    <a class="nav-link" href="dashboard-2.html">Multipurpose</a>
                                    <a class="nav-link" href="dashboard-3.html">Affiliate</a>                                </nav>
                            </div>
                                ...
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                    ...
                                    <div class="collapse" id="pagesCollapseAccount" data-bs-parent="#accordionSidenavPagesMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="account-notifications.html">Notifications</a>                                        </nav>
                                    </div>
                                        ...
                                        <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesAuth">
                                            ...
                                            <div class="collapse" id="pagesCollapseAuthBasic" data-bs-parent="#accordionSidenavPagesAuth">
                                                <nav class="sidenav-menu-nested nav">
                                                    ...
                                                    <a class="nav-link" href="auth-password-basic.html">Forgot Password</a>                                                </nav>
                                            </div>
                                            ...
                                            <div class="collapse" id="pagesCollapseAuthSocial" data-bs-parent="#accordionSidenavPagesAuth">
                                                <nav class="sidenav-menu-nested nav">
                                                    ...
                                                    <a class="nav-link" href="auth-password-social.html">Forgot Password</a>                                                </nav>
                                            </div>
                                      </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseError" data-bs-parent="#accordionSidenavPagesMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="error-504.html">504 Error</a>                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseKnowledgeBase" data-bs-parent="#accordionSidenavPagesMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="knowledge-base-article.html">Article</a>                                        </nav>
                                    </div>
                                    <a class="nav-link" href="pricing.html">Pricing</a>
                                    <a class="nav-link" href="invoice.html">Invoice</a>                              </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseFlows" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="wizard.html">Wizard</a>                                </nav>
                            </div>
                                ...
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                                    ...
                                    <div class="collapse" id="collapseLayoutSidenavVariations" data-bs-parent="#accordionSidenavLayout">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="layout-rtl.html">RTL Layout</a>                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="collapseLayoutContainers" data-bs-parent="#accordionSidenavLayout">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="layout-fluid.html">Fluid Layout</a>                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="collapseLayoutsPageHeaders" data-bs-parent="#accordionSidenavLayout">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="header-light.html">Light</a>                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="collapseLayoutsStarterTemplates" data-bs-parent="#accordionSidenavLayout">
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="starter-minimal.html">Minimal</a>                                        </nav>
                                    </div>
                              </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseComponents" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="tooltips.html">Tooltips</a>                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseUtilities" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="typography.html">Typography</a>                                </nav>
                            </div>
		...
		<script src="style/templates/js/Chart.min.js"></script>
		<script src="style/templates/js/chart-area-demo.js"></script>
		<script src="style/templates/js/chart-bar-demo.js"></script>
		<script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest"></script>
		<script src="style/templates/js/datatables-simple-demo.js"></script>
		<script src="style/templates/js/bundle.js"></script>
